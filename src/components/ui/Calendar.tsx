...
export function Calendar({
    ...
    return (
        <DayPicker
            ...
            components={{
                IconLeft: ({ className }) => <ChevronRight className={cn("h-4 w-4 text-slate-600", className)} />,
                IconRight: ({ className }) => <ChevronLeft className={cn("h-4 w-4 text-slate-600", className)} />,
            }}
            {...props}
        />
    );
